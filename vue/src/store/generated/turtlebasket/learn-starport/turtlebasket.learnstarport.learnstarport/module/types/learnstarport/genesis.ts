...
const baseGenesisState: object = { bchTxCount: 0, xmrTxCount: 0, dogeTxCount: 0, ethTxCount: 0, btcTxCount: 0 }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 9:
          ...
          break
        case 10:
          message.bchTxCount = longToNumber(reader.uint64() as Long)
          break
        case 7:
          message.xmrTxList.push(XmrTx.decode(reader, reader.uint32()))
          break
        case 8:
          message.xmrTxCount = longToNumber(reader.uint64() as Long)
          break
        case 5:
          message.dogeTxList.push(DogeTx.decode(reader, reader.uint32()))
          break
        case 6:
          message.dogeTxCount = longToNumber(reader.uint64() as Long)
          break
        case 3:
          message.ethTxList.push(EthTx.decode(reader, reader.uint32()))
          break
        case 4:
          message.ethTxCount = longToNumber(reader.uint64() as Long)
          break
        case 1:
          message.btcTxList.push(BtcTx.decode(reader, reader.uint32()))
          break
        case 2:
          message.btcTxCount = longToNumber(reader.uint64() as Long)
          break
        default:
